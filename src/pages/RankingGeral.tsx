...
export default function RankingGeral() {
  ...
  function renderLinha(item: AlunoRanking, idx: number) {
    const pos = idx + 1;
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className={`font-semibold text-gray-900 ${pos < 4 ? "text-lg" : "font-medium"}`}>
                {item.username || item.nome_completo}
              </p>
          ...
          <div className="text-right">
            <p className={`text-2xl font-bold ${txt || "text-gray-900"}`}>{Math.round(item.totalPontuacao)}</p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">Ranking Geral</h1>
                <p className="text-sm text-gray-500">Classificação de todos os alunos</p>
              </div>
            </div>
          </div>
        </div>
